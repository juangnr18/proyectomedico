...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Usuario nuevo') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('notas.crear') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="edad" type="number" class="form-control @error('edad') is-invalid @enderror" name="edad" required autocomplete="edad">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="rut" type="number" class="form-control" name="rut" required autocomplete="rut">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <label for="telefono" class="col-md-4 col-form-label text-md-end">{{ __('Contacto') }}</label>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fechadenacimiento" type="date" class="form-control @error('fechadenacimiento') is-invalid @enderror" name="fechadenacimiento" value="{{ old('fechadenacimiento') }}" required autocomplete="fechadenacimiento">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="sexo" class="form-control @error('sexo') is-invalid @enderror" name="sexo" value="{{ old('sexo') }}">
                        ...
                        <div class="row mb-3">
                            <label for="direccion" class="col-md-4 col-form-label text-md-end">{{ __('Domicilio') }}</label>

                            <div class="col-md-6">
                                <input id="direccion" type="adress" class="form-control @error('direccion') is-invalid @enderror" name="direccion" value="{{ old('direccion') }}" required autocomplete="direccion">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="comuna" type="adress" class="form-control @error('comuna') is-invalid @enderror" name="comuna" value="{{ old('comuna') }}" required autocomplete="comuna">
