        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                    @if (Route::has('especialidad'))
                        <a href="{{ route('especialidad') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Especialidad</a>
                        @endif
...
<H1 style="color: white">Bienvenidos a la clinica del Dr House</H1>
    </body>
</html>
